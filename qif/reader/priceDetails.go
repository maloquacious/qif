...
func priceDetails(buf []byte, lineNo int) (totalBytesConsumed int, linesConsumed int, details []*qif.PriceDetail, err error) {
	var detail *qif.PriceDetail
