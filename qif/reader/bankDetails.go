...
func bankDetails(buf []byte, lineNo int) (totalBytesConsumed int, linesConsumed int, details []*qif.BankDetail, err error) {
	var detail *qif.BankDetail
