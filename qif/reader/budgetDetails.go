...
func budgetDetails(buf []byte, lineNo int) (totalBytesConsumed int, linesConsumed int, details []*qif.BudgetDetail, err error) {
	var detail *qif.BudgetDetail
